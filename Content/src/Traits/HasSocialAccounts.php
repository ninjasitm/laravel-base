...
trait HasSocialAccounts {
     ...
     *
     * @param \MadWeb\SocialAuth\Models\SocialProvider $social
    ...
    public function socials() {
        return $this->belongsToMany(\MadWeb\SocialAuth\Models\SocialProvider::class, $this->getSocialAccountsTable())
            ->as('token')
