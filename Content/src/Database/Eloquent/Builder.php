...
namespace Nitm\Content\Eloquent;

use October\Rain\Database\Builder as BaseBuilder;
use Nitm\Content\Eloquent\Builder as NitmBuilder;
use Str;

class Builder extends BaseBuilder
{
    protected static $_eagerLoad = [];
    ...
    public static function appendEagerLoad($with)
    {
        ...
        if (!empty($with)) {
            foreach ($with as $name => $value) {
                if (is_numeric($name)) {
                    array_push(NitmBuilder::$_eagerLoad, $value);
                    NitmBuilder::$_eagerLoad = array_unique(NitmBuilder::$_eagerLoad);
                } else {
                    NitmBuilder::$_eagerLoad[$name] = $value;
                }
            }
        }
    }
    ...
    {
        NitmBuilder::$_eagerLoad = $this->parseWithRelations(NitmBuilder::$_eagerLoad);

        return NitmBuilder::$_eagerLoad;
    }
