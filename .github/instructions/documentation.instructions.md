...
- Any work tracked by issue IDs (GitLab issues/tickets)
...
**Created**: {{Date}}
**Issue**: [{{ISSUE_ID}}](https://gitlab.com/nitm/laravel-base/-/issues/{{ISSUE_ID}})
...
- `Content/src/Models/FeatureName.php`
- `tests/Feature/FeatureNameTest.php`

### Modified Files

- `Api/src/Http/routes.php`
- `Content/src/Contracts/FeatureContract.php`
...
- **Issue**: Brief description of the problem
  ...
  - **Files modified**: `path/to/file1.php`, `path/to/file2.php`
