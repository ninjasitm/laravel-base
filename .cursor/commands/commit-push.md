...
- **Branch Safety**: Always push to current branch, never directly to `master`
...
- Modified: Api/src/Http/Controllers/UsersController.php (added validation)
- Added: Helpers/src/UserValidationHelper.php (new utilities)
